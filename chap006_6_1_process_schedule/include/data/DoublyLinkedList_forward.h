...
#ifndef INCLUDE_DATA_DOUBLYLINKEDLIST_FORWARD_H_
#define INCLUDE_DATA_DOUBLYLINKEDLIST_FORWARD_H_
...
#include <functional>
#include <data/DoublyLinkedNode_forward.h>
...
public:
	using ListType = DoublyLinkedList<T>;
...
#endif /* INCLUDE_DATA_DOUBLYLINKEDLIST_FORWARD_H_ */
