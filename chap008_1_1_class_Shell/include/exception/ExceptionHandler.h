...
public:
	...
	void handleSysCallCreateShell(size_t *savedRegs);
	void handleVFSCd(size_t *savedRegs);
	void handleVFSPwd(size_t *savedRegs);
	void handleVFSLs(size_t *savedRegs);
	void handleVFSCreateFile(size_t *savedRegs);
	void handleVFSMoveFile(size_t *savedRegs);
	void handleVFSCopyFile(size_t *savedRegs);
	void handleVFSCat(size_t *savedRegs);
